...
SEXP do_isNSEnv(SEXP call, SEXP op, SEXP args, SEXP env);
SEXP do_regNS(SEXP call, SEXP op, SEXP args, SEXP env);
SEXP do_unregNS(SEXP call, SEXP op, SEXP args, SEXP env);
SEXP do_getRegNS(SEXP call, SEXP op, SEXP args, SEXP env);
SEXP do_getNSRegistry(SEXP call, SEXP op, SEXP args, SEXP env);
SEXP do_importIntoEnv(SEXP call, SEXP op, SEXP args, SEXP env);
SEXP do_envprofile(SEXP call, SEXP op, SEXP args, SEXP env);
