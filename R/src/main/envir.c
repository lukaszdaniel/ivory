...
HIDDEN void unbindVar(SEXP symbol, SEXP rho)
{
    int hashcode;
    int found;
    SEXP c;
...
HIDDEN Rboolean isUnmodifiedSpecSym(SEXP sym, SEXP env) {
