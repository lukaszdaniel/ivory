...
namespace CXXR
{
      ...
      public:
            ...
            void evaluate(Environment *env,
                          MissingArgHandling allow_missing = MissingArgHandling::Error);
            ...
            void evaluateToArray(Environment *env,
                                 ...
                                 MissingArgHandling allow_missing = MissingArgHandling::Error) const;
            ...
            size_t size() const
            {
                  return ConsCell::listLength(list());
            }
      ...
      private:
            ...
            PairList *mutable_list()
            {
                  ...
                  if (m_list && m_list == m_orig_list)
                  {
                        m_list = m_list->clone(RObject::Duplicate::DEEP);
                  }
                  return m_list;
            }
