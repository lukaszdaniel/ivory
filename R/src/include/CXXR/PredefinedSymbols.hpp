...
// symbols in rho and is used to automatically generate boilerplate code
...
PREDEFINED_SYMBOL(R_dot_Class, DotClassSymbol, ".Class");
PREDEFINED_SYMBOL(R_dot_GenericCallEnv, DotGenericCallEnvSymbol, ".GenericCallEnv");
