...
/* This is #included  from ./qnbinom.cpp , .........
*/
...
// this is used in the caller file qnbinom.cpp etc :
...
{
    Rboolean left = Rboolean(lower_tail ? (*z >= p) : (*z < p));
...
/*
* Note : "same" code in qbinom.cpp, qnbinom.cpp __FIXME__ NOT YET for qpois() ??
* FIXME: This is far from optimal [cancellation for p ~= 1, etc]:
*/
#define q_DISCRETE_01_CHECKS()                                                                      \
	do                                                                                              \
	{                                                                                               \
		...
		{                                                                                           \
			...
			/* end{_OLD_} */                                                                        \
			if (p_n == 0)                                                                           \
				R_DBG_printf("** p_n == 0: _NO LONGER_ returning 0");                               \
			if (p_n == 1)                                                                           \
				R_DBG_printf("** p_n == 1: _NO LONGER_ returning +Inf");                            \
		}                                                                                           \
		else                                                                                        \
			p_n = p;                                                                                \
...
#define q_DISCRETE_BODY()                                                                                    \
	...
	{                                                                                                        \
		...
		q_DISCR_CHECK_BOUNDARY(y);                                                                           \
                                                                                                             \
		if (y < 0)                                                                                           \
			y = 0.; /* e.g., for qnbinom(0.5, mu = 3, size = 1e-10) */                                       \
                                                                                                             \
		z = P_DIST(y, _dist_PARS_);                                                                          \
                                                                                                             \
		...
		if (y < _yLarge_)                                                                                    \
			return DO_SEARCH_(y, 1, _dist_PARS_);                                                            \
