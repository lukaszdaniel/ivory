...
void gdi1(double *X, double *E, double *Es, double *rS, double *U1, double *sp,
		...
		int *deriv, int *REML, int *fisher, int *fixed_penalty, int *nthreads);
...
void gdi2(double *X, double *E, double *Es, double *rS, double *U1, double *sp,
		...
		double *D1, double *D2, double *P, double *P1, double *P2, double *ldet,
		double *ldet1, double *ldet2, double *rV, double *rank_tol,
		int *rank_est, int *n, int *q, int *M, int *n_theta, int *Mp,
		int *Enrow, int *rSncol, int *deriv, int *fixed_penalty, int *nt,
		int *type);
...
extern void mgcv_mmult(double *A, double *B, double *C, int *bt, int *ct,
		int *r, int *c, int *n);
