...
void agfit5a(Sint *nusedx, Sint *nvarx, double *yy, double *covar2,
		double *offset2, double *weights2, int *strata, Sint *sort,
...
SEXP agmart3(SEXP surv2, SEXP score2, SEXP weight2, SEXP strata2, SEXP sort2,
		SEXP method2);
...
void agsurv4(Sint *ndeath, double *risk, double *wt, Sint *sn, double *denom,
		double *km);
...
SEXP concordance2(SEXP y, SEXP wt2, SEXP indx2, SEXP ntree2, SEXP sortstop,
		SEXP sortstart);
...
SEXP coxexact(SEXP maxiter2, SEXP y2, SEXP covar2, SEXP offset2, SEXP strata2,
...
void pyears1(Sint *sn, Sint *sny, Sint *sdoevent, double *sy, double *wt,
...
SEXP survfitci(SEXP ftime2, SEXP sort12, SEXP sort22, SEXP ntime2, SEXP status2,
		SEXP cstate2, SEXP wt2, SEXP id2, SEXP p2, SEXP sefit2);
...
SEXP survreg6(SEXP maxiter2, SEXP nvarx, SEXP y, SEXP ny2, SEXP covar2,
		...
		SEXP epsx, SEXP tolx, SEXP dist, SEXP expr, SEXP rho);
...
void survpenal(int whichcase, int nfrail, int nvar2, double **hmat, double **JJ,
		double *hdiag, double *jdiag, double *u, double *beta, double *loglik,
		int ptype, int pdiag, SEXP pexpr1, double *cptr1, SEXP pexpr2,
		double *cptr2, SEXP rho);

SEXP tmerge(SEXP id2, SEXP time1x, SEXP time2x, SEXP newx2, SEXP nid2,
		SEXP ntime2, SEXP x2, SEXP indx2);
