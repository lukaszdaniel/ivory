...
/* #endif */
    ...
    {
#ifdef HAVE_BZIP2
      pfile_in_zip_read_info->bstream.bzalloc = (void *(*) (void *, int, int))nullptr;
      pfile_in_zip_read_info->bstream.bzfree = (free_func)nullptr;
      pfile_in_zip_read_info->bstream.opaque = (voidpf)nullptr;
      pfile_in_zip_read_info->bstream.state = (voidpf)nullptr;
