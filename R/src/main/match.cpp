...
HIDDEN SEXP Rf_matchArgs_NR(SEXP formals, SEXP supplied, SEXP call)
{
    Rboolean seendots;
    int i, arg_i = 0;
...
HIDDEN SEXP Rf_matchArgs_RC(SEXP formals, SEXP supplied, SEXP call)
{
...
HIDDEN SEXP Rf_patchArgsByActuals(SEXP formals, SEXP supplied, SEXP cloenv)
{
