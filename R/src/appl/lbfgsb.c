		   ...
		   int k)
{
	...
	case -5: Rprintf(_("Warning: more than 10 function and gradient evaluations in the last line search")); break;
	case -6: Rprintf(_("Input nbd(%d) is invalid"), k); break;
	case -7: Rprintf(_("l(%d) > u(%d). No feasible solution"), k, k); break;
