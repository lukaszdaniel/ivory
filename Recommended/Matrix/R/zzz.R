...
if(getRversion() >= "3.2.0") {
	...
	.Deprecated(msg = gettext("'cBind' is deprecated. Since R version 3.2.0, base's cbind() should work fine with S4 objects"))
	...
	if(isTRUE(getOption("Matrix.warn")) ||
	   isTRUE(getOption("Matrix.verbose")))
	.Deprecated(msg = gettext("'rBind' is deprecated. Since R version 3.2.0, base's rbind() should work fine with S4 objects"))
