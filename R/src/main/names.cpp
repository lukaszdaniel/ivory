...
#else
    const std::vector<BuiltInFunction *> &BuiltInFunction::getFunctionTable()
    {
...
new BuiltInFunction("break",	do_break, CTXT_BREAK,	0,	0,	{PP_BREAK,   PREC_FN,	  0}),
new BuiltInFunction("next",	do_break, CTXT_NEXT,	0,	0,	{PP_NEXT,    PREC_FN,	  0}),
...
new BuiltInFunction("[<-",		do_subassign,	0,	0,	3,	{PP_SUBASS,  PREC_LEFT,	  1}),
new BuiltInFunction("[[<-",	do_subassign2,	1,	0,	3,	{PP_SUBASS,  PREC_LEFT,	  1}),
...
new BuiltInFunction(".addGlobHands",do_addGlobHands,	0,	111,	5,	{PP_FUNCALL, PREC_FN,	  0}),
new BuiltInFunction(".resetCondHands",do_resetCondHands,	0,	111,	1,	{PP_FUNCALL, PREC_FN,	  0}),
...
new BuiltInFunction(".addTryHandlers",do_addTryHandlers,	0,	111,	0,	{PP_FUNCALL, PREC_FN,	  0}),
...
new BuiltInFunction("interruptsSuspended",do_interruptsSuspended, 0,	11,	-1,	{PP_FUNCALL, PREC_FN,	  0}),
...
new BuiltInFunction("C_tryCatchHelper",do_tryCatchHelper,0,11,	-1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("getNamespaceValue",	do_getNSValue,	0,	211,	3,	{PP_FUNCALL, PREC_FN,	  0}),
...
new BuiltInFunction("==",		do_relop,	EQOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction("!=",		do_relop,	NEOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction("<",		do_relop,	LTOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction("<=",		do_relop,	LEOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction(">=",		do_relop,	GEOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction(">",		do_relop,	GTOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction("&",		do_logic,	1,	1,	2,	{PP_BINARY,  PREC_AND,	  0}, nullptr, Dispatch::GROUP_OPS),
new BuiltInFunction("|",		do_logic,	2,	1,	2,	{PP_BINARY,  PREC_OR,	  0}, nullptr, Dispatch::GROUP_OPS),
...
new BuiltInFunction("::",		do_colon2,	0,	200,	2,	{PP_BINARY2, PREC_NS,	  0}),
new BuiltInFunction(":::",		do_colon3,	0,	200,	2,	{PP_BINARY2, PREC_NS,	  0}),
...
new BuiltInFunction("...elt",      do_dotsElt,	0,    201,	1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("...length",   do_dotsLength,	0,	1,	0,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("...names",    do_dotsNames,	0,	1,	0,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction(".class2",	R_do_data_class,2,	1,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("attributes",	do_attributes,	0,	1,	1,	{PP_FUNCALL, PREC_FN,	0}, nullptr, Dispatch::INTERNAL),
...
new BuiltInFunction("@<-",		do_attrgets,	1,	0,	3,	{PP_SUBASS,  PREC_LEFT,	  1}),
...
new BuiltInFunction("crossprod",	do_matprod,	1,	11,	2,	{PP_FUNCALL, PREC_FN,   0}),
new BuiltInFunction("tcrossprod",	do_matprod,	2,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("lengths",	do_lengths,	0,	11,	2,	{PP_FUNCALL, PREC_FN,	0}, nullptr, Dispatch::INTERNAL),
new BuiltInFunction("sequence",	do_sequence,	0,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
...
/*
  ...
  This is most of the do_math[23], and all of the do_math4, do_random[123]
*/
new BuiltInFunction("dchisq",	do_math2,	6,	11,	2+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pchisq",	do_math2,	7,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qchisq",	do_math2,	8,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dexp",	do_math2,	9,	11,	2+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pexp",	do_math2,	10,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qexp",	do_math2,	11,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dgeom",	do_math2,	12,	11,	2+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pgeom",	do_math2,	13,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qgeom",	do_math2,	14,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dpois",	do_math2,	15,	11,	2+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("ppois",	do_math2,	16,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qpois",	do_math2,	17,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dt",		do_math2,	18,	11,	2+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pt",		do_math2,	19,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qt",		do_math2,	20,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dsignrank",	do_math2,	21,	11,	2+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("psignrank",	do_math2,	22,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qsignrank",	do_math2,	23,	11,	2+2,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("dbeta",	do_math3,	1,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pbeta",	do_math3,	2,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qbeta",	do_math3,	3,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dbinom",	do_math3,	4,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pbinom",	do_math3,	5,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qbinom",	do_math3,	6,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dcauchy",	do_math3,	7,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pcauchy",	do_math3,	8,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qcauchy",	do_math3,	9,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("df",		do_math3,	10,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pf",		do_math3,	11,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qf",		do_math3,	12,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dgamma",	do_math3,	13,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pgamma",	do_math3,	14,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qgamma",	do_math3,	15,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dlnorm",	do_math3,	16,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("plnorm",	do_math3,	17,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qlnorm",	do_math3,	18,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dlogis",	do_math3,	19,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("plogis",	do_math3,	20,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qlogis",	do_math3,	21,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dnbinom",	do_math3,	22,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnbinom",	do_math3,	23,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnbinom",	do_math3,	24,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dnorm",	do_math3,	25,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnorm",	do_math3,	26,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnorm",	do_math3,	27,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dunif",	do_math3,	28,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("punif",	do_math3,	29,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qunif",	do_math3,	30,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dweibull",	do_math3,	31,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pweibull",	do_math3,	32,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qweibull",	do_math3,	33,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dnchisq",	do_math3,	34,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnchisq",	do_math3,	35,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnchisq",	do_math3,	36,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dnt",		do_math3,	37,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnt",		do_math3,	38,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnt",		do_math3,	39,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dwilcox",	do_math3,	40,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pwilcox",	do_math3,	41,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qwilcox",	do_math3,	42,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("dnbinom_mu",	do_math3,	45,	11,	3+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnbinom_mu",	do_math3,	46,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnbinom_mu",	do_math3,	47,	11,	3+2,	{PP_FUNCALL, PREC_FN,	0}),


/* Mathematical Functions of Four Numeric (+ 1-2 int) Variables */

new BuiltInFunction("dhyper",	do_math4,	1,	11,	4+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("phyper",	do_math4,	2,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qhyper",	do_math4,	3,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dnbeta",	do_math4,	4,	11,	4+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnbeta",	do_math4,	5,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnbeta",	do_math4,	6,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dnf",		do_math4,	7,	11,	4+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("pnf",		do_math4,	8,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qnf",		do_math4,	9,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("dtukey",	do_math4,	10,	11,	4+1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("ptukey",	do_math4,	11,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("qtukey",	do_math4,	12,	11,	4+2,	{PP_FUNCALL, PREC_FN,	0}),

/* Random Numbers */

new BuiltInFunction("rchisq",	do_random1,	0,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rexp",	do_random1,	1,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rgeom",	do_random1,	2,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rpois",	do_random1,	3,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rt",		do_random1,	4,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rsignrank",	do_random1,	5,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("rbeta",	do_random2,	0,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rbinom",	do_random2,	1,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rcauchy",	do_random2,	2,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rf",		do_random2,	3,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rgamma",	do_random2,	4,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rlnorm",	do_random2,	5,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rlogis",	do_random2,	6,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rnbinom",	do_random2,	7,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rnbinom_mu",	do_random2,	13,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rnchisq",	do_random2,	12,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rnorm",	do_random2,	8,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("runif",	do_random2,	9,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rweibull",	do_random2,	10,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("rwilcox",	do_random2,	11,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),

new BuiltInFunction("rhyper",	do_random3,	0,	11,	4,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("RNGkind",	do_RNGkind,	0,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("set.seed",	do_setseed,	0,	111,	4,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("as.vector",	do_asvector,	0,	11,	2,	{PP_FUNCALL, PREC_FN,	0}, nullptr, Dispatch::INTERNAL),
new BuiltInFunction("paste",	do_paste,	0,	11,	4,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("paste0",	do_paste,	1,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("str2lang",	do_str2lang,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("str2expression", do_str2lang, 1,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("numToBits",	do_numToBits,	1,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("numToInts",	do_numToInts,	1,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("machine",	do_machine,	0,	11,	0,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("loadInfoFromConn2",do_loadFromConn2,1, 11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("serializeInfoFromConn",do_unserializeFromConn, 1, 11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("print.default",do_printdefault,0,	111,	3,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("prmatrix",	do_prmatrix,	0,	111,	6,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("gc",		do_gc,		0,	11,	3,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("mem.maxVSize",do_maxVSize,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("mem.maxNSize",do_maxNSize,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("sorted_fpass",do_sorted_fpass,0,      11,     3,      {PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("bodyCode",	do_bodyCode,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("tryWrap",	do_tryWrap,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("altrep_class",do_altrep_class, 0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("unlink",	do_unlink,	0,	111,	4,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("save.to.file", do_savefile,   0,      11,     4,      {PP_FUNCALL, PREC_FN, 0}),
...
new BuiltInFunction("url",		do_url,		0,      11,     6,      {PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("socketConnection",do_sockconn,0,	11,     8,      {PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("socketAccept",do_sockconn,	1,	11,     6,      {PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("sockSelect",do_sockselect,	0,	11,     3,      {PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("serverSocket",do_serversocket,0,	11,     1,      {PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("socketTimeout",do_socktimeout,0,	11,     2,      {PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("gzcon",	do_gzcon,	0,      11,     4,      {PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("activeBindingFunction", do_activeBndFun,	0, 11,	2,      {PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("mkUnbound",	do_mkUnbound,		0, 111,	1,      {PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("pretty",	do_pretty,	0,	11,	8,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("formatC",	do_formatC,	0,	11,	7,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("crc64",	do_crc64,	0,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("curlGetHeaders",do_curlGetHeaders,0,	11,	5,	{PP_FUNCALL, PREC_FN,	0}),
new BuiltInFunction("curlDownload",do_curlDownload, 0,	11,	6,	{PP_FUNCALL, PREC_FN,	0}),

// new BuiltInFunction(nullptr,		nullptr,		0,	0,	0,	{PP_INVALID, PREC_FN,	0}),
        };
...
HIDDEN int R::StrToInternal(const char *s)
{
    ...
    return NA_INTEGER;
#else
    BuiltInFunction *fun = BuiltInFunction::obtainPrimitive(s);
    if (fun)
        return fun->offset();
    return NA_INTEGER;
#endif
...
static void installFunTab(int i)
{
    ...
    if ((R_FunTab[i].evalargs() % 100) / 10) // function is internal
...
HIDDEN SEXP do_internal(SEXP call, SEXP op, SEXP args, SEXP env)
{
    ...
    if(flag < 2 && flag == Evaluator::resultPrinted()) {
