...
SEXP C_axis(SEXP args)
{
    ...
    */
    ...
    Rboolean x_axis = Rboolean(side == 1 || side == 3);
    args = CDR(args);
    ...
    */
	...
	x_axis
	? Rboolean(gpptr(dd)->las == 2 || gpptr(dd)->las == 3)
	: Rboolean(gpptr(dd)->las == 1 || gpptr(dd)->las == 2);
    ...
    Rboolean create_at = Rboolean(isNull(at));
    if (create_at) // graphics engine (in ../../../main/plot.cpp ):
