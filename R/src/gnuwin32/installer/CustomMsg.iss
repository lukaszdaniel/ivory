...
po.adminprivilegesrequired=Do instalacji R trzeba posiadać uprawnienia administratora
po.adminexplanation=Pełna instalacja R wymaga uprawnienia administratora, które nie są dostępne. Jeśli ta instalacja będzie kontynuowana, powiązanie plików .RData z R nie będzie możliwe. Instalacja R jest możliwa tylko w katalogu z prawem zapisu dla użytkownika dokonującego instalacji.
...
po.Internetq=Czy chcesz używać biblioteki internet2.dll, by wykorzystać ustawienie proxy z Internet Explorer?
