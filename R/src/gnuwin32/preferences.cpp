...
extern char fontname[LF_FACESIZE+4]; /* from console.cpp */
extern int consolex, consoley; /* from console.cpp */
extern int pagerMultiple, haveusedapager; /* from pager.cpp */
