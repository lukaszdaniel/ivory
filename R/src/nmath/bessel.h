...
*/
constexpr int nsig_BESS = 16;
constexpr double ensig_BESS = 1e16;
constexpr double rtnsig_BESS = 1e-4;
constexpr double enmten_BESS = 8.9e-308;
constexpr double enten_BESS = 1e308;

constexpr double exparg_BESS = 709.;
constexpr double xlrg_BESS_IJ = 1e5;
constexpr double xlrg_BESS_Y = 1e8;
constexpr double thresh_BESS_Y = 16.;

constexpr double xmax_BESS_K = 705.342; /* maximal x for UNscaled answer */

/* sqrt(DBL_MIN) =	1.491668e-154 */
constexpr double sqxmin_BESS_K = 1.49e-154;
