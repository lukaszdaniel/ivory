...
void setup_Rmainloop(void)
{
    ...
    */
    ...
    R_unLockBinding(Symbol::obtain(".First"), R_BaseEnv);
    R_unLockBinding(Symbol::obtain(".Last"), R_BaseEnv);
    ...
    R_LockBinding(Symbol::obtain(".First"), R_BaseEnv);
    R_LockBinding(Symbol::obtain(".Last"), R_BaseEnv);    
